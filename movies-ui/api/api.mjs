...
async function _getExample (url, request) {
  const response = await fetch(`${url}/example?${new URLSearchParams(Object.entries(request || {})).toString()}`)
...
async function _getMoviesServiceExample (url, request) {
  const response = await fetch(`${url}/movies-service/example?${new URLSearchParams(Object.entries(request || {})).toString()}`)
...
async function _getMoviesServiceUpperMovies (url, request) {
  const response = await fetch(`${url}/movies-service/upperMovies?${new URLSearchParams(Object.entries(request || {})).toString()}`)
...
async function _moviesDbGetMovies (url, request) {
  const response = await fetch(`${url}/movies-db/movies/?${new URLSearchParams(Object.entries(request || {})).toString()}`)
...
async function _moviesDbGetMovieById (url, request) {
  const response = await fetch(`${url}/movies-db/movies/${request.id}?${new URLSearchParams(Object.entries(request || {})).toString()}`)
...
async function _getMoviesDbExample (url, request) {
  const response = await fetch(`${url}/movies-db/example?${new URLSearchParams(Object.entries(request || {})).toString()}`)
